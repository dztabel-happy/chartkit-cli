...
| | | |
|:---:|:---:|:---:|
| <img src="examples/showcase/reference/01-distribution-box-strip.png" alt="ChartKit distribution box plot" width="260"><br><sub><strong>Distribution box plot</strong></sub> | <img src="examples/showcase/reference/02-delta-bar-with-points.png" alt="ChartKit delta bar chart" width="260"><br><sub><strong>Delta bar chart</strong></sub> | <img src="examples/showcase/reference/03-clustered-scatter.png" alt="ChartKit clustered scatter plot" width="260"><br><sub><strong>Clustered scatter plot</strong></sub> |
| <img src="examples/showcase/reference/04-correlation-heatmap.png" alt="ChartKit correlation heatmap" width="260"><br><sub><strong>Correlation heatmap</strong></sub> | <img src="examples/showcase/reference/05-forest-interval.png" alt="ChartKit forest interval plot" width="260"><br><sub><strong>Forest interval plot</strong></sub> | <img src="examples/showcase/reference/06-area-trajectory.png" alt="ChartKit area trajectory chart" width="260"><br><sub><strong>Area trajectory chart</strong></sub> |
| <img src="examples/showcase/reference/07-benchmark-score-bars.png" alt="ChartKit benchmark bar chart" width="260"><br><sub><strong>Benchmark bar chart</strong></sub> | <img src="examples/showcase/reference/08-ridge-distribution.png" alt="ChartKit ridge distribution plot" width="260"><br><sub><strong>Ridge distribution plot</strong></sub> | <img src="examples/showcase/reference/09-signed-effect-heatmap.png" alt="ChartKit signed effect heatmap" width="260"><br><sub><strong>Signed effect heatmap</strong></sub> |
| <img src="examples/showcase/reference/10-line-validation-trajectory.png" alt="ChartKit validation line chart" width="260"><br><sub><strong>Validation line chart</strong></sub> | <img src="examples/showcase/reference/11-mixed-dual-axis.png" alt="ChartKit dual-axis mixed chart" width="260"><br><sub><strong>Dual-axis mixed chart</strong></sub> | <img src="examples/showcase/reference/12-distribution-histogram.png" alt="ChartKit distribution histogram" width="260"><br><sub><strong>Distribution histogram</strong></sub> |
| <img src="examples/showcase/reference/13-ranked-contribution-pareto.png" alt="ChartKit ranked Pareto contribution chart" width="260"><br><sub><strong>Ranked Pareto contribution</strong></sub> | <img src="examples/showcase/reference/14-volcano-scatter.png" alt="ChartKit volcano scatter plot" width="260"><br><sub><strong>Volcano scatter plot</strong></sub> | <img src="examples/showcase/reference/15-bubble-matrix.png" alt="ChartKit bubble matrix" width="260"><br><sub><strong>Bubble matrix</strong></sub> |
| <img src="examples/showcase/reference/16-stacked-area-composition.png" alt="ChartKit stacked area chart" width="260"><br><sub><strong>Stacked area chart</strong></sub> | <img src="examples/showcase/reference/17-contribution-waterfall.png" alt="ChartKit contribution waterfall chart" width="260"><br><sub><strong>Contribution waterfall</strong></sub> | <img src="examples/showcase/reference/18-profile-benchmark.png" alt="ChartKit radar benchmark profile" width="260"><br><sub><strong>Radar benchmark profile</strong></sub> |
| <img src="examples/showcase/reference/19-time-series-events.png" alt="ChartKit event time series chart" width="260"><br><sub><strong>Event time series</strong></sub> | <img src="examples/showcase/reference/20-distribution-violin.png" alt="ChartKit violin distribution plot" width="260"><br><sub><strong>Violin distribution plot</strong></sub> | <img src="examples/showcase/reference/21-bar-percent-stack.png" alt="ChartKit percent stacked bar chart" width="260"><br><sub><strong>Percent stacked bar</strong></sub> |
| <img src="examples/showcase/reference/22-contribution-lollipop-ranking.png" alt="ChartKit lollipop ranking chart" width="260"><br><sub><strong>Lollipop ranking chart</strong></sub> | <img src="examples/showcase/reference/23-line-slopegraph.png" alt="ChartKit slopegraph" width="260"><br><sub><strong>Slopegraph</strong></sub> | <img src="examples/showcase/reference/24-time-series-error-band.png" alt="ChartKit error-band time series chart" width="260"><br><sub><strong>Error-band time series</strong></sub> |
